import {createMetaRouteProcessor, createRedirectRouteProcessor, createRouter, MetaRouteData, ReactRouteData, RedirectRouteData, RouteDeclaration, Router} from 'ui-router';
